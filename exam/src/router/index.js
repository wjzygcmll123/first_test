  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        {path: '/adminPsw', component: () => import('@/components/common/manager')},
        {
    ...
    },
    {
      ...
      children: [
        ...
        {path: '/teacherPsw', component: () => import('@/components/common/manager')},
        {
        ...
        {
          path: '/kgCharts',
          component: () => import('@/components/charts/kgCharts')
        },
        {
    ...
    //学生
    {
      ...
      children: [
        ...
        {path: '/studentPsw', component: () => import('@/components/common/manager')},
